...
// Struct que describe toda la memoria del sistema
...
// Reserva página y nos deja la dirección en el puntero
void reserve_page(void*);
void unreserve_page(void*);
void lock_page(void*);
void unlock_page(void*);

// Reserva páginaS = pagina * N  
...
// Páginas contiguas, utiles para PCI
